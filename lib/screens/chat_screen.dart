...
User signedInUser;//this will give us the email
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  final _auth = FirebaseAuth.instance;
   String messageText; // this with give us the message
  @override
  void initState() {
    super.initState();
    getCurrentUser();
...
class MessageLine extends StatelessWidget {
  const MessageLine({this.text, this.sender, this.isMe, Key key}) : super(key: key);
